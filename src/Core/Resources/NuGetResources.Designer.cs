...
namespace NuGet.Resources {
    ...
    public class NuGetResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The minimum client version must be greater than &apos;{0}&apos; when quirks mode is enabled..
        /// </summary>
        public static string MinClientVersion_MustBeHigher {
            get {
                return ResourceManager.GetString("MinClientVersion_MustBeHigher", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The following paths do not map to a well-known target framework: {0}..
        /// </summary>
        public static string StrictTfm_UnsupportedFilePath {
            get {
                return ResourceManager.GetString("StrictTfm_UnsupportedFilePath", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unsupported package type &apos;{0}&apos;..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unsupported package type version &apos;{0}&apos;..
        /// </summary>
        public static string UnsupportedPackageTypeVersion {
            get {
                return ResourceManager.GetString("UnsupportedPackageTypeVersion", resourceCulture);
            }
        }
