...
namespace NuGet.Resources {
    ...
    internal class AnalysisResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The file &apos;{0}&apos; is directly placed under the &apos;{1}&apos; folder. Support for file paths that do not specify frameworks will be deprecated in the future..
        /// </summary>
        internal static string FileUnderWellKnownFolderDescription {
            get {
                return ResourceManager.GetString("FileUnderWellKnownFolderDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Move it into a framework-specific folder and run the pack command specifying the package type..
        /// </summary>
        internal static string FileUnderWellKnownSolution {
            get {
                return ResourceManager.GetString("FileUnderWellKnownSolution", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to File not inside a framework folder..
        /// </summary>
        internal static string FileUnderWellKnownTitle {
            get {
                return ResourceManager.GetString("FileUnderWellKnownTitle", resourceCulture);
            }
        }
