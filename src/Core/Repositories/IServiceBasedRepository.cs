...
namespace NuGet
{
    public interface IServiceBasedRepository : IPackageRepository
    {
        ...
        IEnumerable<IPackage> GetUpdates(IEnumerable<IPackage> packages, bool includePrerelease, bool includeAllVersions, IEnumerable<FrameworkName> targetFrameworks);
    }
}
