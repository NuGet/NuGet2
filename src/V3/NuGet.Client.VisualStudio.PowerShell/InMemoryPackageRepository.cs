...
{
    public class InMemoryPackageRepository: PackageRepositoryBase, ICollection<IPackage>, ILatestPackageLookup, IOperationAwareRepository, IPackageLookup
    {
        ...
        public InMemoryPackageRepository(string source)
        {
