...
namespace NuGet.Client.Interop
{
    public class V2InteropActionResolver : IActionResolver
    {
        ...
        private static ActionResolver CreateResolver(ResolverContext context)
        {
        ...
        private static DependencyVersion GetDependencyVersion(DependencyBehavior dependencyBehavior)
        {
        ...
        private static PackageAction ConvertAction(PackageActionType action)
        {
            switch (action)
            {
