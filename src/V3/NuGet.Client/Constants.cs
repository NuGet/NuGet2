...
namespace NuGet.Client
{
    public static class Types
    {
        ...
        public static readonly Uri PackageVersionList = new Uri("http://schema.nuget.org/schema#PackageVersionList");
        public static readonly Uri PackageVersion = new Uri("http://schema.nuget.org/schema#PackageVersion");
    ...
    public static class Properties
    {
        ...
        public static readonly string PackageVersionList = "packageVersionList";
        public static readonly string HasAdditionalVersions = "hasAdditionalVersions";
    }
}
