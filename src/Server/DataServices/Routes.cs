    ...
    public static class NuGetRoutes {
        ...
        private static void MapRoutes(RouteCollection routes) {
            ...
            routes.MapDelegate("CreatePackage",
                               ...
                               requestContext => CreatePackageService().CreatePackage(requestContext.HttpContext));

            // Route to publish a package
            routes.MapDelegate("PublishPackage",
                               "PublishedPackages/Publish",
                               requestContext => CreatePackageService().PublishPackage(requestContext.HttpContext));

            // Route to delete packages
            routes.MapDelegate("DeletePackage",
                               "Packages/{apiKey}/{packageId}/{version}",
                               requestContext => CreatePackageService().DeletePackage(requestContext.HttpContext));
