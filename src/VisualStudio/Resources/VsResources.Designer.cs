...
namespace NuGet.VisualStudio.Resources {
    ...
    public class VsResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The package attempted to set property &apos;{0}&apos; to the value &apos;{1}&apos; on the project item &apos;{2}&apos;, but the property was unavailable..
        /// </summary>
        public static string ProjectFileProcessor_PropertyNotFound {
            get {
                return ResourceManager.GetString("ProjectFileProcessor_PropertyNotFound", resourceCulture);
            }
        }
