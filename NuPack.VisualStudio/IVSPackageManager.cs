...
namespace NuGet.VisualStudio {
    public interface IVsPackageManager : IPackageManager {
        ...
        void InstallPackage(IProjectManager projectManager, IPackage package, IEnumerable<PackageOperation> operations, bool ignoreDependencies);
        ...
        void UpdatePackage(IProjectManager projectManager, IPackage package, IEnumerable<PackageOperation> operations, bool updateDependencies);
