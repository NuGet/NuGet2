...
FindReplace @("*.xaml") "Microsoft.VisualStudio.Shell.10.0" "Microsoft.VisualStudio.Shell.14.0"
...
FindReplace @("*.vsixmanifest") "<Name>NuGet Package Manager</Name>" "<Name>NuGet Package Manager for Visual Studio Next</Name>"
