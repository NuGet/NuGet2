...
namespace NuGet.Dialog {
    ...
    public class CommonResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0} seems to be not a valid pdb file ({1}).
        /// </summary>
        public static string InvalidPDBFile {
            get {
                return ResourceManager.GetString("InvalidPDBFile", resourceCulture);
            }
        }
    }
}
