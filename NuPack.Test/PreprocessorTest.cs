...
namespace NuPack.Test {
    ...
    public class PreprocessorTest {        
        ...
        public void TransformFileReplacesTokensWithValueAndReturnsModifiedStream() {
            ...
            // Act
            processor.TransformFile(mockFile.Object, "foo.bar", mockProjectSystem.Object, DefaultPackageEventListener.Instance);
        ...
        public void TransformFileThrowsIfTokenValueIsNull() {
            ...
            // Act
            ExceptionAssert.Throws<InvalidOperationException>(() => processor.TransformFile(mockFile.Object, "foo.bar", mockProjectSystem.Object, DefaultPackageEventListener.Instance), "The replacement token 'token' has no value.");
        }
        ...
        public void RevertFileRemovesFileIfContentIsTheSame() {
            ...
            // Act
            processor.RevertFile(mockFile.Object, "foo.bar", Enumerable.Empty<IPackageFile>(), mockProjectSystem.Object, DefaultPackageEventListener.Instance);
