...
namespace NuGet.PowerShell.Commands.Test
{
    public class UpdatePackageCommandTest
    {
        ...
        public void UpdatePackageCmdletThrowsWhenSolutionIsClosed()
        {
            ...
            var cmdlet = new UpdatePackageCommand(TestUtils.GetSolutionManager(isSolutionOpen: false), packageManagerFactory.Object, null, null, null, null, new Mock<IFileOpener>().Object);
        ...
        public void UpdatePackageCmdletUsesPackageManangerWithSourceIfSpecified()
        {
            ...
            var cmdlet = new UpdatePackageCommand(TestUtils.GetSolutionManagerWithProjects("foo"), packageManagerFactory.Object, repositoryFactory.Object, sourceProvider, null, null, new Mock<IFileOpener>().Object);
        ...
        public void UpdatePackageCmdletInvokeProductUpdateCheckWhenSourceIsHttpAddress()
        {
            ...
            var cmdlet = new UpdatePackageCommand(TestUtils.GetSolutionManagerWithProjects("foo"), packageManagerFactory.Object, repositoryFactory.Object, sourceProvider, null, productUpdateService.Object, new Mock<IFileOpener>().Object);
            cmdlet.Id = "my-id";
            cmdlet.Version = new SemanticVersion("2.8");
            cmdlet.IgnoreDependencies = new SwitchParameter(isPresent: true);
