...
namespace NuGet.PowerShell.Commands.Test
{
    ...
    public class FindPackageCommandTest
    {
        ...
        private static IVsPackageManager GetPackageManager()
        {
            ...
            return new VsPackageManager(TestUtils.GetSolutionManager(), remoteRepo.Object, new Mock<IFileSystemProvider>().Object, fileSystem.Object, localRepo.Object, new Mock<VsPackageInstallerEvents>().Object);
        }
