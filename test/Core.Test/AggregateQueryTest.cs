...
namespace NuGet.Test {
    ...
    public class AggregateQueryTest {
        ...
        public void AggregateQueryIgnoresInvalidRepositoriesIfFlagIsSet() {
            ...
            // Act
            var aggregateQuery = new AggregateQuery<string>(sources, StringComparer.Ordinal, ignoreInvalidRepositories: true).OrderBy(c => c);
        ...
        public void AggregateQueryThrowsForInvalidRepositoriesIfFlagIsSet() {
            ...
            ExceptionAssert.Throws<AggregateException>(
                () => new AggregateQuery<string>(sources, StringComparer.Ordinal, ignoreInvalidRepositories: false).OrderBy(c => c).ToArray());
        }
