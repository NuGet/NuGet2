...
namespace NuGet.Test
{
	public class ZipPackageTest
	{
		...
		{
			// Arrange
			var file = new PhysicalPackageFile { TargetPath = PathFixUtility.FixPath(@"content\foo.dll") };
		...
		{
			// Arrange
			var file = new PhysicalPackageFile { TargetPath = PathFixUtility.FixPath(@"lib\foo.txt") };
			IEnumerable<string> references = null;
		...
		{
			// Arrange
			var file = new PhysicalPackageFile { TargetPath = PathFixUtility.FixPath(@"lib\NuGet.resources.dll") };
			IEnumerable<string> references = null;
