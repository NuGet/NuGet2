...
", index++));
            ...
            Assert.Equal(new SemVer("1.5"), package.Version);
...
<package>
  ...
  <files>
    ...
    <file src=""bin\Debug\*.xml"" target=""lib\net40"" />
            ...
            Assert.Equal(new SemVer("1.3"), package.Version);
...
<package>
  <metadata>
    ...
    <authors>Auth</authors>
            ...
            Assert.Equal(new SemVer("1.1"), package.Version);
...
<package>
  <metadata>
    ...
    <authors>Auth</authors>
            ...
            Assert.Equal(new SemVer("2.5"), package.Version);
            Assert.Equal("Auth", package.Authors.First());
            Assert.Equal("Desc", package.Description);
        }
